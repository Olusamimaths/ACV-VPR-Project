...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth,height=4.7cm,keepaspectratio]{../../output_images/legacy/campus_place_level/campus_place_level_pr_curve.png}
\caption{Place-level PR curve summary on the campus dataset.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=\linewidth,height=3.8cm,keepaspectratio]{../../output_images/legacy/campus_place_level/campus_place_level_matches_examples.png}
