...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \PosterBlock{82.0cm}{17.8cm}{33.8cm}{%
    ...
    \begin{minipage}[t]{16.0cm}
      \centering
      \includegraphics[width=\linewidth,height=10.6cm,keepaspectratio]{../../output_images/campus_place_level_pr_curve.png}
    \end{minipage}\hfill
    \begin{minipage}[t]{16.8cm}
      \centering
      \includegraphics[width=\linewidth,height=10.6cm,keepaspectratio]{../../output_images/campus_place_level_matching_results.png}
    \end{minipage}
