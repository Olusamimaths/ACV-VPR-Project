...
def main():
    ...
    parser.add_argument('--vprtempo_model_path', type=str, default=None,
                       help='Checkpoint path for VPRTempo (required when descriptor=VPRTempo)')
    parser.add_argument('--vprtempo_dims', type=str, default='56,56',
                       help="Input dims for VPRTempo preprocessing, e.g. '56,56'")
    parser.add_argument('--vprtempo_patches', type=int, default=15,
